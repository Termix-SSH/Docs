...
function A(l) {
  var n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1,
    e =
      n > 0 ? l.toFixed(n).replace(/0+$/, "").replace(/\.$/, "") : l.toString();
  return e || "0";
}
var N = (function () {
  function l(n, e, t, r) {
    ...
    function o(a) {
      if (a.startsWith("hsl")) {
        ...
        a.startsWith("#")
          ? (i.rgba = l.hexToRgb(a))
          : (i.rgba = l.nameToRgb(a) || l.hexToRgb(a));
    }
    if (n !== void 0)
      ...
      [
        ...
        },
        {
          ...
          value: function (e) {
            ...
            return r === void 0
              ? r
              : l.hexToRgb(r.replace(/\-/g, "00").padStart(6, "f"));
          },
        },
        {
          key: "rgbToHsl",
        ...
        },
        {
          ...
          value: function (e, t, r) {
            this._events = this._events.filter(function (i) {
              var o = true;
              return (
                e && e !== i.target && (o = false),
                t && t !== i.type && (o = false),
                r && r !== i.handler && (o = false),
        ...
        value: function (e) {
          ...
          if (e instanceof HTMLElement) r.parent = e;
            ...
            (r.parent &&
              e.parent &&
              r.parent !== e.parent &&
              (this._events.remove(r.parent), (this._popupInited = false)),
              i(e, r),
      ...
      },
      {
        ...
        value: function (e, t) {
          if ((typeof e == "string" && (e = e.trim()), !!e)) {
            ...
            ((this.colour = this.color = r),
              this._setHSLA(null, null, null, null, t));
          }
        },
      },
      {
